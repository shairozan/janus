...
func TestParseImageReference(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			imageRef:     "shairozan/hermes-nonmem:nm76",
		...
		},
		{
			...
			imageRef:     "shairozan/hermes-nonmem",
			expectedName: "shairozan/hermes-nonmem",
			expectedTag:  "latest",
		...
		},
		{
			...
			imageRef:     "ghcr.io/shairozan/hermes:v1.0.0",
			expectedName: "ghcr.io/shairozan/hermes",
			expectedTag:  "v1.0.0",
			description:  "GitHub Container Registry with semantic version tag",
		},
		{
			name:         "GitHub Container Registry without tag",
			imageRef:     "ghcr.io/shairozan/hermes",
			expectedName: "ghcr.io/shairozan/hermes",
			expectedTag:  "latest",
